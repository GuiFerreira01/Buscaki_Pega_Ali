            ...
            <div className="container j-center">
                <div id="margin" className="row j-login">
                    <div className="col-12 col-sm-7 col-md-6 col-lg-7 ">
                        <a href="/"><img className="col-12 j-elementos-login" src={Logo} alt="" /></a>
                    </div>
                    <div className="col-12 col-sm-12 col-md-6 col-lg-5 p-3">
                        <div className="j-elementos-login">
                            ...
                            <input type="text" placeholder="E-mail" autocomplete="off" name="email" className="col-12 m-2 p-1 j-input-login form-control" />
                            <input type="password" placeholder="senha" autocomplete="off" name="senha" className="col-12 m-2 p-1 j-input-login form-control" />
                            <Link type="button" to="/=" className="col-12 m-2 btn btn-outline-info">Entrar</Link>
